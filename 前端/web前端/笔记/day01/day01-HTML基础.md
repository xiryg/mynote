...
* 综合案例一 - 个人简介
  ...
  ![](assets/1680242340931.png)

* 综合案例二 - Vue 简介

  ![](assets/1680242362352.png)
...
* 父子关系（嵌套关系）：子级标签换行且缩进（Tab键）
  ...
  ![](assets/1680255766672.png)

* 兄弟关系（并列关系）：兄弟标签换行要对齐

  ![](assets/1680255775150.png)
